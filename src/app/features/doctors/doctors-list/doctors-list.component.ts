...
@Component({
  selector: 'ck-doctors-list',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="ck-page-header">
      <h1 class="ck-page-title">Doctors</h1>
      <p class="ck-page-sub">All physicians and specialists.</p>
    </div>
    <div class="ck-placeholder-banner">
      <i class="ri-tools-line"></i>
      <p>Doctors directory — coming in Week 2 sprint.</p>
    </div>
  `,
  styles: [`
