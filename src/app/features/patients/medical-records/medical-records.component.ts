...
@Component({
  ...
  template: `
    <div class="ck-page-header">
      <h1 class="ck-page-title">Medical Records</h1>
      <p class="ck-page-sub">View and manage patient medical records.</p>
    </div>
    <div class="ck-placeholder-banner">
      <i class="ri-tools-line"></i>
      <p>Medical records module — coming in Week 2 sprint.</p>
    </div>
  `,
  styles: [`
