...
@Component({
  selector: 'ck-insurance',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="ck-page-header"><h1 class="ck-page-title">Insurance</h1></div>
    <div class="ck-placeholder-banner"><i class="ri-tools-line"></i><p>Insurance management — Week 2 sprint.</p></div>
  `,
