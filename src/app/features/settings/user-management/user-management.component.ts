...
@Component({
  selector: 'ck-user-management',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="ck-page-header"><h1 class="ck-page-title">Users & Roles</h1><p class="ck-page-sub">Manage system users and role permissions.</p></div>
    <div class="ck-placeholder-banner"><i class="ri-tools-line"></i><p>User management — Week 2 sprint.</p></div>
  `,
