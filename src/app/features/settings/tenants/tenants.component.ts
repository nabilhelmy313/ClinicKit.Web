...
@Component({
  ...
  template: `
    <div class="ck-page-header"><h1 class="ck-page-title">Tenants</h1><p class="ck-page-sub">Multi-clinic tenant management.</p></div>
    <div class="ck-placeholder-banner"><i class="ri-tools-line"></i><p>Tenant management — Week 2 sprint.</p></div>
  `,
