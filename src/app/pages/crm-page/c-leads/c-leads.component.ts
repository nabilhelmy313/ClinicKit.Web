...
@Component({
    ...
    imports: [RouterLink, MatCardModule, NewLeadsComponent, ActiveLeadsComponent, LeadConversionComponent, RevenueGrowthComponent, MatTooltipModule, MatCheckboxModule, MatPaginatorModule, MatTableModule, MatButtonModule],
