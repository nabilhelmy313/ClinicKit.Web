...
@Component({
    ...
    imports: [MatCardModule, MatMenuModule, MatButtonModule, MatTableModule, MatCheckboxModule, MatTooltipModule, MatSelectModule, MatInputModule, MatDatepickerModule, MatNativeDateModule],
