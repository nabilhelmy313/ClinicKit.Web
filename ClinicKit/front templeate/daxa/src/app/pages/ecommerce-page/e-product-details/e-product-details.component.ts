...
@Component({
    ...
    imports: [RouterLink, MatCardModule, MatMenuModule, MatButtonModule, CarouselModule, FormsModule, MatTabsModule, MatFormFieldModule, MatInputModule, FormsModule, StarRatingComponent, MatProgressBarModule],
