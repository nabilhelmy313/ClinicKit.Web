...
@Component({
  ...
  template: `
    <div class="ck-page-header">
      <h1 class="ck-page-title">Patients</h1>
      <p class="ck-page-sub">Manage all registered patients.</p>
    </div>
    <div class="ck-placeholder-banner">
      <i class="ri-tools-line"></i>
      <p>Patient list table — coming in Week 2 sprint (search, filter, pagination).</p>
    </div>
  `,
  styles: [`
