...
@Component({
  selector: 'ck-clinic-profile',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="ck-page-header"><h1 class="ck-page-title">Clinic Profile</h1><p class="ck-page-sub">Manage clinic information and branding.</p></div>
    <div class="ck-placeholder-banner"><i class="ri-tools-line"></i><p>Clinic settings form — Week 2 sprint.</p></div>
  `,
