...
@Component({
  ...
  template: `
    <div class="ck-page-header">
      <h1 class="ck-page-title">Appointment Calendar</h1>
      <p class="ck-page-sub">Visual calendar view of all appointments.</p>
    </div>
    <div class="ck-placeholder-banner">
      <i class="ri-tools-line"></i>
      <p>FullCalendar integration — coming in Week 2 sprint.</p>
    </div>
  `,
  styles: [`
